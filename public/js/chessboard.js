const startBoard = game => {
    ...
    const resetBoard = () => {
        ...
        for (const piece of game.pieces) {
            ...
            square.innerHTML = `<img class="piece ${piece.rank}" id="${piece.name}" src="/images/chessimg/${piece.color}-${piece.rank}.png">`
        }
    }
    ...
    game.on('promotion', queen => {
        ...
        square.innerHTML = `<img class="piece queen" id="${queen.name}" src="/images/chessimg/${queen.color}Queen.png">`;
    })
...
const game = new chessGame(pieces);
