...
document.getElementById('play-game').addEventListener('click', function() {
  ...
  //Logic to start the game or navigate to the game page
  window.location.href = '/gameCheckersPlay';
});

//Event listener for 'Invite Friends' button
document.getElementById('invite-friends').addEventListener('click', function() {

  //Logic to invite friends, such as opening a modal to send invites
  openInviteModal();
});
